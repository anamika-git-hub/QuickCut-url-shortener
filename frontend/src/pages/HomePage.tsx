    ...
    <div className="py-12 sm:py-20">
      <div className="text-center mx-auto max-w-3xl px-4">
        <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-4">
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-gray-600 to-purple-600">QuickCut</span>
        </h1>
          ...
          <div className="flex flex-col items-center">
            ...
            {isAuthenticated ? (
              <div className="w-full">
                <Link 
                  to="/dashboard" 
                  className="block w-full text-center py-3 px-4 bg-gray-600 text-white font-medium rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors"
                >
                  Go to Dashboard
                </Link>
              </div>
              ...
              <div className="w-full space-y-3">
                ...
                <Link 
                  to="/login" 
                  className="block w-full text-center py-3 px-4 bg-white text-gray-600 font-medium rounded-md border border-gray-600 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors"
                >
                  Sign In
                </Link>
              </div>
